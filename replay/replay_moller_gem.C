...
void replay_moller_gem( int runnum=770, int firstsegment=0, int maxsegments=1, long firstevent=0, long nevents=1000 ){
  ...
  lastsegment = 1;
  TString outfilename;
  outfilename.Form( "%s/moller_uvagem_replayed_%d_seg%d_%d.root", prefix.Data(), runnum,firstsegment,lastsegment);
